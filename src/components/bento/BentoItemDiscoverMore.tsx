  ...
  return (
    <a href="#projects" className="flex h-full items-center justify-between group cursor-pointer">
      <div className="relative">
        <span className="text-[var(--t-text-primary)]">Discover more projects</span>
        <div className="absolute bottom-0 left-0 w-0 h-[2px] bg-[var(--t-accent)] transition-all duration-300 group-hover:w-full" />
      </div>
      <svg
